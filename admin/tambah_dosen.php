		...
		<div class="content">
			...
			if(isset($_POST['add'])){ 
				...
				if(mysqli_num_rows($cek) == 0){ 
					if($pass1 == $pass2){ 
						$pass = md5($pass1); 
						$insert = mysqli_query($koneksi, "INSERT INTO dosen(nip, nama, jenis_kelamin, tempat_lahir, tanggal_lahir, dosen_matkul,alamat, telepon, email, level, username, password) VALUES('$nip','$nama', '$jenis_kelamin', '$tempat_lahir', '$tanggal_lahir', '$dosen_matkul','$alamat', '$telepon', '$email','$level', '$username','$pass')") or die(mysqli_error()); 
						if($insert){ 
